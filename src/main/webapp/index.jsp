...
<h1 style="color:yellow;" align="center">Home</h1>
<h2 style="color:red;" align="center" >${message}</h2>
<h2 style="color:red;" align="center" >${success_msg}</h2>

<br><br>

<div style="width:100%; height:50px; background:/resources/static/index.png;"></div>
