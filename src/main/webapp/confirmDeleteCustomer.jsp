...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-75">
      <input type="text" id="ssnid" name="ssnid" value="${customer.getCustomerSSNId() }">
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="row">
    <input type="submit" value="Confirm Delete" href="/confirmDelete">
    <a href="/index"><input type="button" name="cancle" value="Cancel" ${success_msg="Deletion Aborted..!!"}></a>
  </div>
